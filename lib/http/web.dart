...
const String baseUrl = 'http://192.168.0.110:8081/api';
...
void sendDevice(Device device) async {
  ...
  if (response.statusCode != 200) throw Exception('Falha para criar o dispositivo');
  else prefs.setBool('tokenSent', true);
}
